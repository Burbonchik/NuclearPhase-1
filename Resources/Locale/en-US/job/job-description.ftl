...
job-description-centcommoff = Act as an ambassador to the newest state-of-the-art space station in REDACTED's fleet.
...
job-description-ertleader = Lead the Emergency Response Team in dealing with threats to REDACTED assets.
