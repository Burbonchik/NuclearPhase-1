...
tips-dataset-31 = As a Traitor, the REDACTED encryption key can be used to communicate through a secure channel with any other traitors who have purchased it.
tips-dataset-32 = As a Traitor, compromising important communications channels like security or engineering can give valuable intelligence. Be aware that this goes in both ways - security can compromise REDACTED communications as well!
tips-dataset-33 = As a Traitor, the REDACTED toolbox is extremely versatile. For only 2 telecrystals, you can get a full set of tools to help you in an emergency, insulated combat gloves and a REDACTED gas mask.
...
tips-dataset-106 = REDACTED gas masks will both provide welding protection and block flashes. Think twice before trying to flash a Nuclear Operative!
