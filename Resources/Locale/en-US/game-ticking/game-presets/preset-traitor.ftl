...
objective-issuer-syndicate = [color=crimson]The REDACTED[/color]
...
traitor-role-greeting =
    You are an agent sent by [color = darkred]The REDACTED[/color] on behalf of {$corporation}.
...
traitor-role-codewords =
    ...
    {$codewords}.[/color]
    Codewords can be used in regular conversation to identify yourself discreetly to other REDACTED agents.
