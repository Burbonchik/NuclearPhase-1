...
delivery-spam-2 =   Reasons to choose Nanotrasen!
    ...
    .content =      {-delivery-header-nanotrasen}
                    ...
                    {"[head=2]TOP THREE REASONS WHY THE REDACTED IS INCOMPETENT[/head]"}
                    ...
                    THEIR CIVILIANS ARE WEAK TO BULLETS! TRUST ME, WE TRIED! UNLIKE THE REDACTED CIVILIANS, REDACTED CIVILIANS DIE FROM A BULLET TO THE SKULL! BULLETS WE HAVE!
...
delivery-spam-3 =   Reasons to choose The REDACTED!
    .desc =         An advertisement for The REDACTED.
    .content =      {-delivery-header-syndicate}

                    {"[head=2]TOP THREE REASONS WHY REDACTED IS INCOMPETENT[/head]"}
